...
- Si no hay cambios staged, detén el procesamiento y no generes ningún mensaje.
...
1. Subject (línea de título) [luego una linea en blanco]
...
2. Body (cuerpo) Opcional [luego una linea en blanco]
...
3. Footer (Opcional) Incluye un pie de commit solo cuando exista un BREAKING
   CHANGE real y evidente en el diff. No lo inventes ni lo asumas por cambios
   menores o cosméticos. Criterios claros para considerarlo (cualquiera de estos
   debe cumplirse):
